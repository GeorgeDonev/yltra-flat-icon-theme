...
echo "Yltra-Flat"
gtk-update-icon-cache -f Yltra-Flat
echo "Yltra-Flat-Arch-Blue"
gtk-update-icon-cache -f Yltra-Flat-Arch-Blue
echo "Yltra-Flat-Majestic"
gtk-update-icon-cache -f Yltra-Flat-Majestic
echo "Yltra-Flat-Green"
gtk-update-icon-cache -f Yltra-Flat-Mint-Green
echo "Yltra-Flat-Orange"
gtk-update-icon-cache -f Yltra-Flat-Orange
